...
import styles from "../BackgroundPage/backgroundPage.module.css"
    ...
    return (
        ...
        <div className={styles.backgroundPageContainer} style={{backgroundColor: "#254557"}}>
            ...
            <ul className={styles.backgroundImage}>
                <li><img src={image1} alt="pctr"/></li>
                <li><img src={image2} alt="pctr"/></li>
                <li><img src={image3} alt="pctr"/></li>
                <li><img src={image4} alt="pctr"/></li>
                <li><img src={image9} alt="pctr"/></li>
                <li><img src={image5} alt="pctr"/></li>
                <li><img src={image6} alt="pctr"/></li>
                <li><img src={image7} alt="pctr"/></li>
