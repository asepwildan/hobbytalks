...
export default function RelatedTopic() {
    ...
    useEffect(() => {
        axios
            .get(
                `https://hobbytalk-be-glints.herokuapp.com/api/v1/threads/relatedtopic/${idThread}`
                // {
                //     headers: {
                    ...
                    <div className={styles.titleThreadTopic}>
                        ...
                        <div className={styles.threadActionContainer}>
                            <div className={styles.threadAction}>
                                ...
                                <div className={styles.threadVoteInfo}>{topic.likeCount}</div>
                            </div>
                            <div className={styles.threadAction}>
                                <svg
                                    width="14"
                                ...
                                <div className={styles.threadActionInfo}>{topic.dislikeCount}</div>
                            </div>
                            <div className={styles.threadAction}>
                                <svg
                                    width="16"
                                ...
                                <div className={styles.threadActionInfo}>{topic.commentCount}</div>
                            </div>
                        </div>
                    </div>
                </div>
