...
export default function MoreUserInfo() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://hobbytalk-be-glints.herokuapp.com/api/v1/threads/more/6166e34d04911310aafedac9/616a814e2d9ef9e211bb0328"
      )
      .then((response) => {
    ...
    <div className={styles.moreUserInfoContainer}>
      ...
      <div>
        ...
        {/* <div className={styles.listUserInfoContainer}>
          ...
          <div className={styles.titleListUser}>
            <p className={styles.titleUserText}>
          ...
          <div className={styles.userInfoActionContainer}>
            <div className={styles.userInfoAction}>
              ...
              <div className={styles.moreUserActionLike}>1.5k</div>
            </div>
            <div className={styles.userInfoAction}>
              <svg
                width="14"
              ...
              <div className={styles.moreUserActionLike}>0</div>
            </div>
            <div className={styles.userInfoAction}>
              <svg
                width="16"
              ...
              <div className={styles.moreUserActionLike}>124</div>
            </div>
          </div>
        </div> */}
      </div>
