...
import styles from "../moreUserInfo/style/moreUserInfo.module.css";
import image from "../moreUserInfo/img/imgMoreStella.png";
...
import NotfoundTopic from "../like-recomendation/img/notfound.png";
export default function MoreUserInfo() {
    ...
    const { idThread, name, idUser, loading } = useSelector((state) => state.getThreadDetail);

    useEffect(() => {
        axios
            .get(`https://hobbytalk-be-glints.herokuapp.com/api/v1/threads/more/${idThreadUrl}`)
            .then((response) => {
        ...
        <div className={styles.moreUserInfoContainer}>
            ...
            {!moreUserInfo.length ? (
                <div className={styles.containerNotFound}>
                    ...
                    <p className={styles.notfoundTexth2}>
                        Oops, {name} don't have any other thread
                    </p>
                </div>
            ) : (
                <div>
                    {moreUserInfo.map((moreInfoUser) => (
                        <div className={styles.listUserInfoContainer}>
                            <a
                                href={`/thread-detail/?xyz=${moreInfoUser._id}`}
                            ...
                            <a
                                ...
                                <div className={styles.userInfoActionContainer}>
                                    <div className={styles.userInfoAction}>
                                        ...
                                        <div className={styles.moreUserActionLike}>
                                            {moreInfoUser.likes.length}
                                        </div>
                                    </div>
                                    <div className={styles.userInfoAction}>
                                        <svg
