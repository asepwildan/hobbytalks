...
export default function Thread() {
    ...
    const [loadervoteDown, setLoadervoteDown] = useState(false);
    ...
    }, [dispatch, page, vote, loadervoteDown, loadervote]);

    const upVote = (e) => {
        console.log(e, "klink id");
        setLoadervote(true);
        axios({
            method: "PUT",
            url: `https://hobbytalk-be-glints.herokuapp.com/api/v1/threads/upvote/${e}`,
            headers: {
    ...
    const downVote = (e) => {
        console.log(e, "klink id");
        setLoadervoteDown(true);
        axios({
            method: "PUT",
            url: `https://hobbytalk-be-glints.herokuapp.com/api/v1/threads/downvote/${e}`,
            headers: {
                Authorization: `Bearer ${token} `,
            },
        })
                    ...
                    <div key={thread.userId} className={styles.threadListProfile}>
                        <div className={styles.titleThreadProfile}>
                            ...
                            <div className={styles.threadActionContainer}>
                                    ...
                                    <div
                                        ...
                                        <svg
                                            ...
                                            <path
                                                ...
                                                fill={
                                                    thread.likes[index]?.user === profileInfo._id
                                                        ? "#1E8AC6"
                                                        : "#828282"
                                                }
                                            />
                                ...
                                {loadervoteDown === true ? (
                                    <div className={styles.loadervoteDown}>
                                        <img src={arrow} alt="loader vote" />
                                    </div>
                                ) : (
                                    <div
                                        className={styles.threadAction}
                                        onClick={() => downVote(thread._id)}>
                                        <svg
                                            width="14"
                                            height="16"
                                            viewBox="0 0 14 16"
                                            ...
                                            <path
                                                ...
                                                // fill="#828282"
                                                fill={
                                                    thread?.dislike[index]?.user === profileInfo._id
                                                        ? "#1E8AC6"
                                                        : "#828282"
                                                }
                                            />
