            ...
            <div key={comment._id} className={styles.commentWrapper}>
                <div className={styles.commentRightPart}>
                    {comment.userId === null ? (
                        ...
                        <Link
                            to={
                                comment.userId._id === profileInfo._id
                                    ? `/profile`
                                    : `/account-detail/?xyz=${comment.userId._id}`
                            }>
                ...
                <div className={styles.commentContent}>
                    ...
                    <div className={styles.commentActionContainer}>
                        <div
                            ...
                            onClick={() => upVoteComment(comment._id, cLickSound2)}>
                            <svg
                                width="14"
                                height="16"
                                viewBox="0 0 14 16"
                                ...
                                <path
                                    ...
                                    fill={
                                        comment.likes.filter((e) => e.user === profileInfo._id)
                                            .length > 0
                                            ? "#1E8AC6"
                                            : "#828282"
                                    }
                        ...
                        <div
                            className={styles.commentAction}
                            onClick={() => downVoteComment(comment._id, cLickSound2)}>
                            <svg
                                width="14"
                                height="16"
                                viewBox="0 0 14 16"
                                ...
                                <path
                                    ...
                                    fill={
                                        comment.dislike.filter((e) => e.user === profileInfo._id)
                                            .length > 0
                                            ? "#1E8AC6"
                                            : "#828282"
                                    }
