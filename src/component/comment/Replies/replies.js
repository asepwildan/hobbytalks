...
export default function SubComment({ replies, ava, updateComment }) {
    ...
    const upVoteReplies = (idReplies, src) => {
    ...
    const downVoteReplies = (idReplies, src) => {
        const sound = new Howl({
            src,
        });
        sound.play();
            ...
            <div className={styles.repliesWrapper}>
                <div className={styles.repliestRightPart}>
                    {rep.userId === null ? (
                        ...
                        <Link
                            to={
                                rep.userId._id === profileInfo._id
                                    ? `/profile`
                                    : `/account-detail/?xyz=${rep.userId._id}`
                            }>
                            {" "}
                            <Avatar
                ...
                <div className={styles.repliesContent}>
                    ...
                    <div className={styles.repliesActionContainer}>
                        <div
                            className={styles.repliesAction}
                            onClick={() => upVoteReplies(rep.id, cLickSound2)}>
                            <svg
                                width="14"
                                height="16"
                                viewBox="0 0 14 16"
                                ...
                                <path
                                    ...
                                    fill={
                                        rep.likes.filter((e) => e.user === profileInfo._id).length >
                                        0
                                            ? "#1E8AC6"
                                            : "#828282"
                                    }
                        ...
                        <div
                            className={styles.repliesAction}
                            onClick={() => downVoteReplies(rep.id, cLickSound2)}>
                            <svg
                                width="14"
                                height="16"
                                viewBox="0 0 14 16"
                                ...
                                <path
                                    ...
                                    fill={
                                        rep.dislike.filter((e) => e.user === profileInfo._id)
                                            .length > 0
                                            ? "#1E8AC6"
                                            : "#828282"
                                    }
