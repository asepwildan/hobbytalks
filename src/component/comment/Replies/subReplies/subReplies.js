...
export default function SubReplies({ subReplies, ava, updateComment }) {
    ...
    const upVoteSubReplies = (idSubReplies, src) => {
    ...
    const downVoteSubReplies = (idSubReplies, src) => {
        const sound = new Howl({
            src,
        });
        sound.play();
        ...
        return (
            <div className={styles.subRepliesWrapper}>
                <div className={styles.subRepliesRightPart}>
                    {subRep.userId === null ? (
                        <Avatar className={styles.subRepavatar} alt="A" />
                    ) : (
                        <Avatar
                            className={styles.subRepavatar}
                            src={subRep.userId.avatar}
                            alt="A"
                        />
                    )}
                    {subRep.userId === null ? (
                ...
                <div className={styles.subRepliesContent}>
                    ...
                    <div className={styles.subRepliesActionContainer}>
                        <div
                            className={styles.subRepliesAction}
                            onClick={() => upVoteSubReplies(subRep.id, cLickSound2)}>
                            <svg
                                width="14"
                                height="16"
                                viewBox="0 0 14 16"
                                ...
                                <path
                                    ...
                                    fill={
                                        subRep.likes.filter((e) => e.user === profileInfo._id)
                                            .length > 0
                                            ? "#1E8AC6"
                                            : "#828282"
                                    }
                        ...
                        <div
                            className={styles.subRepliesAction}
                            onClick={() => downVoteSubReplies(subRep.id, cLickSound2)}>
                            <svg
                                width="14"
                                height="16"
                                viewBox="0 0 14 16"
                                ...
                                <path
                                    ...
                                    fill={
                                        subRep.dislike.filter((e) => e.user === profileInfo._id)
                                            .length > 0
                                            ? "#1E8AC6"
                                            : "#828282"
                                    }
