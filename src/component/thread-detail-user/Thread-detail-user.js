...
import SkeletonThreadDetail from "../skeletonThreadDetail/skeletonThreadDetail";
...
export default function ThreadUser() {
    ...
    for (var i = 0; i < likes.length; i++) {
        if (likes[i]?.user === profileInfo._id) {
            fillVote = "#1E8AC6";
            filloff = "#1E8AC6";
            break;
        }
                ...
                <div className={styles.threadDetailUserContainer}>
                    <div className={styles.buttonActionProfileContainer}>
                        ...
                        {idUser === profileInfo._id ? (
                            <div className={styles.buttonFIlter2}></div>
                        ) : (
                            <div className={styles.buttonFIlter2}>
                                {userFollow === false ? (
                                    <button
                                        className={styles.followButtonThread}
                                        onClick={followThread}>
                                        {followLoad === true ? (
                                            <div className={styles.buttonFollow}>
                                                <img className="gambarPlus" src={loadingDelete} />{" "}
                                                Follow Thread
                                            </div>
                                        ) : (
                                            <div className={styles.buttonFollow}>
                                                <img className="gambarPlus" src={plus} /> Follow
                                                Thread{" "}
                                            </div>
                                        )}
                                    </button>
                                    ...
                                    <button
                                        ...
                                        {unfollowLoad === true ? (
                                            ...
                                            <div className={styles.buttonFollow}> Followed</div>
                                        )}
                                    </button>
                                )}
                            </div>
                    ...
                    <Link
                        ...
                        <div className={styles.identitas}>
                            <img className={styles.foto} src={avatar} alt="foto"></img>
