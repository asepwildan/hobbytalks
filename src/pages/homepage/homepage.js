        ...
        <div className={styles.homeContent}>
            <div className={styles.contentLeft}>
                ...
                <div className={styles.paragraphContainer}>
                  <p>Ut sapien, neque, a nulla neque vestibulum. Ligula enim velit neque, vitae eu venenatis vel. Pretium pretium tincidunt magna aenean vitae auctor mus.</p>
                </div>
            ...
            <div className={styles.contentRight}>
                <div className={styles.homeSearch}>
                  <div className={styles.homeInputContainer}>
                      <input type="text" name="home-input" placeholder="What do you want to talk about?" />
