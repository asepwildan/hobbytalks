                            ...
                            <nav className={styles.homeNav}>
                                ...
                                <div className={styles.homeButtonContainer}>
                                    <Link to={`/account/login`} style={{ textDecoration: "none" }}>
                                        <button className={styles.buttonLoginHomepage}>
                                            Login
                                        </button>
                                    </Link>
                                    <Link
                                        ...
                                        <button className={styles.buttonSignupHomepage}>
                                            Signup
                                        </button>
                                    </Link>
                                </div>
                        ...
                        <div className={styles.homeContent}>
                            <div className={styles.contentLeft}>
                                ...
                                <div className={styles.paragraphContainer}>
                                    <p>
                                        Ut sapien, neque, a nulla neque vestibulum. Ligula enim
                                        velit neque, vitae eu venenatis vel. Pretium pretium
                                        tincidunt magna aenean vitae auctor mus.
                                    </p>
                                </div>
                            </div>
